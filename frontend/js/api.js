...
window.api = {
    ...
    logout: async () => { try { await fetchAPI('/auth/logout', { method: 'POST' }); } catch {} clearAuth(); },
    deactivateMe: () => fetchAPI('/users/me', { method: 'DELETE' }),
    ...
    updateRecommendation: (recId, data) => fetchAPI(`/recommendations/${recId}`, { method: 'PATCH', body: data }),
