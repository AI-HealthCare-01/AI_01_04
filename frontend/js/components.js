    ...
    const sidebarHtml = `
        <div class="p-4 d-flex flex-column h-100">
            <div class="mb-4 text-center">
                ...
                <h4 class="fw-bold text-primary-custom mt-2 mb-0">HealthCare AI</h4>
                <p class="text-soft small mt-1">당신의 곁에, 언제나</p>
            </div>
            ...
            <div class="menu-list flex-grow-1">
                <p class="text-soft fw-bold mb-2 small px-2">나의 건강 서비스</p>
